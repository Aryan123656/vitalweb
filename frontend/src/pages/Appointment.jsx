...
//                     </div>
//                      <div>
//                         <p className='flex items-center gap-1 text-sm font-medium text-[#262626] mt-3'>Address <img className='w-3' src={assets.info_icon} alt="" /></p>
...
//                     {docSlots.length && docSlots.map((item, index =0) => (
//                         <>
//                         {
//                             !item[0]?<></>:
        ...
        <div>
            ...
            {docInfo.address && (
                <div className='w-full mt-4'>
                    <p className='text-2xl text-primary font-medium mb-2'>Clinic Location</p>
                    <MapContainer 
                        center={[0, 0]} 
                        zoom={15} 
                    ...
                    {docSlots.length && docSlots.map((item, index) => (
                        <>
                        {
                            ...
                            <div 
                                ...
                                key={index} 
                                className={`text-center py-6 min-w-16 rounded-full cursor-pointer ${slotIndex === index ? 'bg-primary text-orange-300' : 'border border-[#DDDDDD]'}`}
                            >
                                <p>{item[0] && daysOfWeek[item[0].datetime.getDay()]}</p>
                                <p>{item[0] && item[0].datetime.getDate()}</p>
                            </div>
